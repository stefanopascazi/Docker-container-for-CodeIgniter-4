<?php namespace App\Models\SitesEav;
...
class Index extends Model
{
         ...
         */
        protected $returnType = '\App\Entities\SitesEav\Index';
         ...
         */
        protected $allowedFields = ['site_functionality_id', 'area_id'];
