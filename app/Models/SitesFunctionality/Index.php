<?php namespace App\Models\SitesFunctionality;
...
class Index extends Model
{
         ...
         * Imposto la tabella
         */
        protected $table = 'sites_functionality';
         ...
         */
        protected $returnType = '\App\Entities\SitesFunctionality\Index';
         ...
         */
        protected $allowedFields = ['title', 'user_id', 'default'];
