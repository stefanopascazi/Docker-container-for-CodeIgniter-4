...
<body>
    ...
    <footer>
        ...
        <div class="copyrights">
            ...
            <p>&copy;
                <?= date('Y') ?> CodeIgniter Foundation. CodeIgniter is open source project released under the MIT open source licence.</p>
